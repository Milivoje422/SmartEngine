...
return array (
  ...
  array (
    ...
    'alias' => 
    array (
      '@rkit/filemanager' => $vendorDir . '/rkit/filemanager-yii2/src',
    ),
  ),
  'pendalf89/yii2-scroll-to-top' => 
  array (
    'name' => 'pendalf89/yii2-scroll-to-top',
    'version' => '9999999-dev',
    'alias' => 
    array (
      '@pendalf89/scroll' => $vendorDir . '/pendalf89/yii2-scroll-to-top',
    ),
  ),
  ...
  array (
    ...
    'alias' => 
    array (
      '@pceuropa/email' => $vendorDir . '/pceuropa/yii2-email',
    ),
  ),
  'pceuropa/yii2-forms' => 
  array (
    'name' => 'pceuropa/yii2-forms',
    'version' => '9999999-dev',
    'alias' => 
    array (
      '@pceuropa/forms' => $vendorDir . '/pceuropa/yii2-forms',
    ),
  ),
  'geertw/yii2-adsense' => 
  array (
    'name' => 'geertw/yii2-adsense',
    'version' => '1.0.1.0',
    'alias' => 
    array (
      '@geertw/Yii2/Adsense' => $vendorDir . '/geertw/yii2-adsense',
    ),
  ),
  ...
  array (
    'name' => 'inpassor/yii2-daemon',
    'version' => '0.3.1.0',
    'alias' => 
    array (
      '@inpassor/daemon' => $vendorDir . '/inpassor/yii2-daemon',
    ),
  ),
